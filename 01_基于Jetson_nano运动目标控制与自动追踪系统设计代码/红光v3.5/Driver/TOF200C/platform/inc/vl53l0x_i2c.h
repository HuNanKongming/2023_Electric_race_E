...
//IO方向设置
#define VL_SDA_OUT()  {GPIOA->CRH&=0XFFF0FFFF;GPIOA->CRH|=3<<16;}//PA12
#define VL_SDA_IN() {GPIOA->CRH&=0XFFF0FFFF;GPIOA->CRH|=8<<16;}


//IO操作函数	 
#define VL_IIC_SCL    PAout(11)      //SCL3
#define VL_IIC_SDA    PAout(12) 		//SDA	 2
#define VL_READ_SDA   PAin(12) 		//输入SDA 
